...
class SignupActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonSave = findViewById(R.id.buttonUserCreat)
    ...
    private fun saveUser() {
        ...
        //Gravar o usuário no SharePreferences
        //Step 1 - Obter uma instância no SharePreferences
        val dados = getSharedPreferences("dados", MODE_PRIVATE)

        //Step 2 - Criar um editor para o arquivo
        val editor = dados.edit()

        //Step 3 - Inserir os dados no arquivo SharePreferences
